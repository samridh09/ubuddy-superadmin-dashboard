...
const ErrorMsg = ({ msg }: { msg?: string }) =>
  msg ? (
    <p className="text-red-500 text-[11px] font-bold mt-1.5 ml-1 animate-in fade-in slide-in-from-top-1">
      {msg}
    </p>
  ) : null;

// ─── Main component ───────────────────────────────────────────────────────────
export const ConfigAdminForm = () => {
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="flex-shrink-0 flex flex-col items-center gap-2">
              ...
              >
                {previewUrl ? (
                  ...
                  <>
                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-gray-400 transition-all">
                      <Upload size={16} />
                    </div>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
              ...
              <div>
                ...
                <DateInput
                  ...
                  onChange={(iso) => {
                    ...
                    if (errors.dateOfBirth) validateField("dateOfBirth", iso);
                  }}
                  onBlur={() =>
              ...
              <div>
                ...
                <input
                  name="mobileNumber"
                  value={formatMobile(formData.mobileNumber)}
                  onChange={handleChange}
                  onBlur={handleBlur}
              ...
              <div>
                ...
                <input
                  ...
                  value={formatMobile(formData.alternateMobileNumber)}
                  onChange={handleChange}
                  onBlur={handleBlur}
              ...
              <div className="md:col-span-2">
                <div className="flex justify-between items-end mb-1.5 ml-1">
                  <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-widest leading-none">
                    Remarks
                  </label>
                  <span
                    className={`text-[10px] font-bold ${formData.remarks.length >= 200 ? "text-red-500" : "text-gray-400"}`}
                  >
