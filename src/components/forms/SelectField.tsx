...
export const SelectField = forwardRef<HTMLSelectElement, SelectFieldProps>(
  ({ label, options, error, requiredHint, className = '', ...props }, ref) => {
    return (
      <div className="space-y-1.5 w-full">
        ...
        <select
          ref={ref}
          className={`w-full px-4 py-2.5 border rounded-lg text-[13px] text-[#0F172A] bg-white focus:outline-none focus:ring-2 transition-all ${
            error
